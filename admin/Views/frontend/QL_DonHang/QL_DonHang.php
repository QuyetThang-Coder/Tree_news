        ...
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active">
                    <a href="">
                        <b>Danh sách đơn hàng
                            <?php foreach ($countStatus0 as $countStatus0) {
                                if ($countStatus0["status"] != "0") {
                                    echo " - "."<span style='background-color: #f9c9cd; color: #a90312; padding: 0 4px'>(".$countStatus0["status"]." đơn hàng đang chờ xử lý)</span>";
                                }
                            } ?>
                            <?php foreach ($countStatus1 as $countStatus1) {
                                if ($countStatus1["status"] != "0") {
                                    echo " - "."<span style='background-color: #f2f98a; color: #8b9400; padding: 0 4px'>(".$countStatus1["status"]." đơn hàng đang giao)</span>";
                                }
                            } ?>
                        </b>
                    </a>
                        ...
                        <table class="table table-hover table-bordered table-striped" id="sampleTable">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; width: 200px">Địa chỉ nhận hàng</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">DH<?php echo $getOrder["id"] ?></td>
                                            <td style="text-align: center;"><?php echo $getOrder["order_name"] ?></td>
                                            <td style="text-align: center;"><?php echo $address.', '.$ward_txt.', '.$district_txt.', '.$city_txt ?></td>
                                            <td style="text-align: center;"><?php echo $getOrder["order_phone"] ?></td>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <?php } else if ($getOrder["status"] == 1) { ?>
                                                    <span class="badge bg-warning">Đang giao hàng</span>
                                                <?php } else if ($getOrder["status"] == 2) { ?>
                                                    <span class="badge bg-success">Hoàn thành</span>
                                                <?php } else if ($getOrder["status"] == 3) { ?>
                                            ...
                                            <td style="text-align: center;">
                                                <a class="btn btn-primary btn-sm" style="background-color: #798aff; color: #fff" href="index.php?controller=QL_DonHang&action=view_donhang&id=<?php echo $getOrder["id"] ?>" title="Xem"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
