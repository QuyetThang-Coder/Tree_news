    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile-body">
                <form class="row" action="index.php?controller=QL_ChinhSach&action=add" method="POST" enctype="multipart/form-data">
                    <div class="form-group col-md-3">
                        <label class="control-label">Mã chính sách</label>
                        <input class="form-control" type="number" readonly name="id_policy" placeholder="">
                    </div>
                    <div class="form-group col-md-9">
                        <label class="control-label">Tiêu đề chính sách</label>
                        <input class="form-control" type="text" required autocomplete="off" name="title_policy">
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label">Mô tả ngắn</label>
                        <!-- <input class="form-control" type="text" required autocomplete="off" name="product_price"> -->
                        <textarea class="form-control" name="desc_policy" required autocomplete="off" id="mota"></textarea>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="content_policy" id="myTextarea" cols="30" rows="10" style="resize: vertical;"></textarea>
                    </div>
