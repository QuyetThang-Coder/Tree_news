                    ...
                    <div class="tile-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" id="exampleSelect1" type="text" name="staff_id" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label" for="exampleSelect2">Họ và tên</label>
                                <input class="form-control staff_name" id="exampleSelect2" type="text" name="staff_name" autocomplete="off" >
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label" for="exampleSelect3">Số điện thoại</label>
                                <input class="form-control staff_phone" id="exampleSelect3" type="number" name="staff_phone" autocomplete="off" >
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label" for="exampleSelect4">Địa chỉ email</label>
                                <input class="form-control staff_email" id="exampleSelect4" type="text" name="staff_email" autocomplete="off" >
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group  col-md-4">
                                ...
                                <select class="form-control position" id="exampleSelect6" name="position">
                                    ...
                                    ?>
                                                    <option value="<?php echo $positionAll["id_position"] ?>"><?php echo $positionAll["name_position"] ?></option>
                                    <?php
                                                } 
                                            }
                                        }
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control staff_address" id="exampleSelect7" type="text" name="staff_address" autocomplete="off">
                            </div>

                            <button class="save btn btn-save" style="margin-left: 10px; margin-right: 10px;" id="btn_save" type="submit" name="save" >Lưu lại</button>
