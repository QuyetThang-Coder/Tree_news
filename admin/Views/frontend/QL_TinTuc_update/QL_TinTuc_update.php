    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><a href="index.php?controller=QL_TinTuc">Danh sách tin tức</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Cập nhật tin tức</h3>
                <div class="tile-body">
                <form class="row" action="index.php?controller=QL_TinTuc&action=update" method="POST" enctype="multipart/form-data">
                    <?php foreach ($news as $news) { ?>
                            <div class="form-group col-md-3">
                                <label class="control-label">Mã tin tức</label>
                                <input class="form-control" name="id_news" type="number" value="<?php echo $news["id"] ?>" readonly placeholder="">
                            </div>
                            <div class="form-group col-md-9">
                                <label class="control-label">Tiêu đề tin tức</label>
                                <input class="form-control" type="text" required value="<?php echo $news["title_news"] ?>" autocomplete="off" name="title_news">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Mô tả ngắn</label>
                                <!-- <input class="form-control" type="text" required autocomplete="off" name="product_price"> -->
                                <textarea class="form-control" name="desc_news" required autocomplete="off" id="mota"><?php echo $news["description_news"] ?></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="btn-upload">
                                    <label class="control-label">Ảnh tin tức</label> <br>
                                    <div id="displayImg">
                                        <img src="Public/uploads/<?php echo $news["image_news"] ?>" alt="">
                                    </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="content_news" id="myTextarea" cols="30" rows="10" style="resize: vertical;"><?php echo $news["content_news"] ?></textarea>
                            </div>
                    <?php } ?>
