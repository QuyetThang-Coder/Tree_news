    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile-body">
                <form class="row" action="index.php?controller=QL_TinTuc&action=add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-9">
                        ...
                        <input class="form-control" type="text" required autocomplete="off" name="title_news">
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label">Mô tả ngắn</label>
                        <!-- <input class="form-control" type="text" required autocomplete="off" name="product_price"> -->
                        <textarea class="form-control" name="desc_news" required autocomplete="off" id="mota"></textarea>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="content_news" id="myTextarea" cols="30" rows="10" style="resize: vertical;"></textarea>
                    </div>
