                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control sale_name" type="text" required autocomplete="off" value="" name="sale_name">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="exampleSelect1" class="control-label">Số tiền giảm</label>
                                <input class="form-control sale_price" type="number" required autocomplete="off" value="" name="sale_price">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Điều kiện áp dụng (Đơn hàng trên .... vnđ)</label>
                                <input class="form-control sale_rule" type="number"  autocomplete="off" value="" name="sale_rule">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Số lượng</label>
                                <input class="form-control sale_quantity" type="number"  autocomplete="off" value="" name="sale_quantity">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Ngày bắt đầu</label>
                                <input class="form-control start_day" type="datetime-local" required autocomplete="off" value="" name="start_day">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Ngày kết thúc</label>
                                <input class="form-control end_day" type="datetime-local" required autocomplete="off" value="" name="end_day">
                            </div>
                            <div class="form-group col-md-12">
                                <button class="btn btn-save" id="btn_save_add" style="margin-left: 10px; margin-right: 10px" type="button" name="save">Lưu lại</button>
