  ...
  <main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="">Cập nhật thông tin sản phẩm</a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
                ...
                <form class="row" action="index.php?controller=QL_SanPham&action=update" method="POST" enctype="multipart/form-data">
                    ...
                    ?>
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" value="<?php echo $product["id"] ?>" name="id_product" type="number" readonly placeholder="">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">Tên sản phẩm</label>
                                <input class="form-control product_name" value="<?php echo $product["name_product"] ?>" type="text"  autocomplete="off" name="product_name">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control category" id="exampleSelect1" name="category">
                                    ...
                                    ?>
                                                    <option 
                                                        <?php if ($product['category_id'] == $CategoryAll['id']) { echo 'selected'; } ?>
                                                        value="<?php echo $CategoryAll['id']; ?>"><?php echo $CategoryAll['name_category']; ?>
                                                    </option>
                                    <?php
                                                } 
                                            }
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control product_price" value="<?php echo $product["price_product"] ?>" type="number"  autocomplete="off" name="product_price">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">Giảm giá</label>
                                <input class="form-control product_discount" value="<?php echo $product["discount_product"] ?>" type="number"  autocomplete="off" name="product_discount">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">Số lượng</label>
                                <input class="form-control product_amount" type="number" value="<?php echo $product["amount_product"] ?>"  autocomplete="off" name="product_amount">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Mô tả ngắn</label>
                                <textarea name="product_shortdesc" class="form-control product_shortdesc" id="" cols="40" rows="20" style="resize: vertical;"><?php echo $product["short_description"] ?></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="btn-upload">
                                    <label class="control-label">Ảnh sản phẩm</label> <br>
                                    <div id="displayImg">
                                        <img src="Public/uploads/<?php echo $product["image_product"] ?>" alt="">
                                    </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="product_description" id="myTextarea" class="product_description" cols="30" rows="10" style="resize: vertical;"><?php echo $product["description"] ?></textarea>
                            </div>
                    <?php
                        }
                    ?>
                    <button class="btn btn-save" id="btn_save" style="margin-left: 10px; margin-right: 10px" name="save">Lưu lại</button>
                    <a class="btn btn-cancel" href="index.php?controller=QL_SanPham">Hủy bỏ</a>
                </form>
            </div>
        </div>
  </main>
